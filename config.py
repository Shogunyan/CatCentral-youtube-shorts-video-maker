...
class Config:
    ...
    def __init__(self):
        ...
        # ── YouTube account credentials (headless browser upload fallback) ──
        self.youtube_email: str = os.getenv("YOUTUBE_EMAIL", "")
        self.youtube_password: str = os.getenv("YOUTUBE_PASSWORD", "")
