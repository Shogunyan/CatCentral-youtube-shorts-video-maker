...
def _write_env(
    ...
    # Preserve an existing ANTHROPIC_API_KEY if one is already saved and the
    # caller didn't supply a new one.
    if not anthropic_api_key and ENV_PATH.exists():
...
LOG_LEVEL=INFO
# Optional: Anthropic API key enables AI visual clip-source detection.
